...
import { AddCrime } from '../../store/actions/add.action';
...
<a class="navbar-brand">Crime Report</a>
...
<button onClick={this.Crime} type="submit" class="btn btn-primary">Submit</button>
  </div>
</div>
                    </div>
                </div>
...
const mapDispatchToProp = (dispatch) => {
  return({
    AddCrime: (crime) => {
      dispatch(AddCrime(crime))
    }
  })
}

export default connect(mapStateToProp, mapDispatchToProp) (CrimeReport)