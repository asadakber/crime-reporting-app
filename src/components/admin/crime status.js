...
import { SendCrime, GetSendCrime } from '../../store/actions/feedback.action';
...
class CrimeStatus extends Component {
    constructor(props) {
        ...
        this.sendcrime = this.sendcrime.bind(this)
    ...
    sendcrime = () => {
        ...
        this.props.SendCrime(sendcrime)
  ...
  <button onClick={this.sendcrime} style={{float: 'right'}} type="submit" class="btn btn-primary">Send</button>
  </div>
  </div>
</div>
                            </div>
...
export default connect(mapStateToProp, mapDispatchToProp) (CrimeStatus);